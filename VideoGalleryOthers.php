                        ...
                        <ul>
                            ...
                            <li class="drop-down"><a href="#">Presentations</a>
                                <ul>
                                    ...
                                    <li class="active"><a href="./VideoGalleryOthers.php">Others</a></li>
        ...
        <section id="gallery" class="gallery section-bg mt-5">
            ...
            <h2 class="display-5 mb-5">Product Presentation</h2>
                ...
                <div class="row">
                    ...
                    $ListFolders = mysqli_query($con, "SELECT id,folderName FROM folder_table WHERE categoryId = 2");
                    foreach ($ListFolders as $ListFoldersResults) {
                        echo '
                            <div class="col-xl-3 col-lg-4 col-md-6 col-6 mb-3">
                                <a href="VideoSubFolders.php?CID=2&FID=' . $ListFoldersResults["id"] . '&SFID=">
                                    <div class="card-body Folder">
                                        <img src="./img/folder.jpg" class="img-fluid">
                ...
                <div class="row VideoClientSideRow mt-4">
                    <?php
                    $FetchVideos = mysqli_query($con, "SELECT * FROM video_table WHERE videoCategory = 2 AND videoFolder = 0 AND videoSubFolder = 0");
