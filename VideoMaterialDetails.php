    ...
    <section id="gallery" class="gallery section-bg mt-5">
        <div class="container" data-aos="fade-up">
            ...
            <div class="row VideoClientSideRow">
                <?php
                $FetchVideos = mysqli_query($con, "SELECT * FROM video_table WHERE videoCategory = 1 AND videoFolder = '$VideoMaterialId'");
                foreach ($FetchVideos as $FetchVideoResults) {
                    echo '<div class="col-xl-3 col-lg-3 col-12 mb-4">
                    <a class="VideoCientSide" href="VideoPlay.php?ID=' . $FetchVideoResults["videoId"] . '&VCat=1&VFol='.$VideoMaterialId.'">
