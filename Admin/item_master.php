            ...
            <div class="container-fluid px-xl-5">
                ...
                <!-- Logo -->
                            <div class="logo d-flex">
                               ...
                               <h2 class="navbar-brand my-auto ms-2 fs-4 pt-4 d-none d-md-flex" href="#"> <strong>BUV CHEMICALS</strong> </h2>
                            </div>
                            <a href="../signout.php" class="signoutBtn text-white">Sign Out</a>
            ...
            <div class="card card-body main-card shadow-sm">    
                <form action="" id="add_product" enctype="multipart/form-data" novalidate>
                            ...
                            <div class="row img-box">
                                ...
                                <div class="col-xl-5 col-lg-5 col-12 mt-md-5 pt-md-5 pt-xl-2">
