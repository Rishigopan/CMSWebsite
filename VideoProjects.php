        ...
        <section id="gallery" class="gallery section-bg mt-5">
            <div class="container" data-aos="fade-up">
                <div class="row">
                    ...
                    $ListFolders = mysqli_query($con, "SELECT id,folderName FROM folder_table WHERE categoryId = 3");
                    foreach ($ListFolders as $ListFoldersResults) {
                        echo '
                            <div class="col-xl-3 col-lg-4 col-md-6 col-6 mb-3">
                                <a href="VideoSubFolders.php?CID=3&FID=' . $ListFoldersResults["id"] . '&SFID=">
                    ...
                    <!-- <div class="col-xl-4 col-lg-4 col-md-6 col-6 mb-3 px-lg-5">
                        <a href="VideoProjectsDetails.php?PID=1">
                            <div class="card-body Folder">
                                <img src="./img/folder.jpg" class="img-fluid">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-6 mb-3 px-lg-5">
                        <a href="VideoProjectsDetails.php?PID=3">
                            <div class="card-body Folder">
                                <img src="./img/folder.jpg" class="img-fluid">
                ...
                <div class="row VideoClientSideRow mt-4">
                    <?php
                    $FetchVideos = mysqli_query($con, "SELECT * FROM video_table WHERE videoCategory = 3 AND videoFolder = 0 AND videoSubFolder = 0");
                    foreach ($FetchVideos as $FetchVideoResults) {
                        echo '<div class="col-xl-3 col-lg-3 col-12 mb-4">
                                <a class="VideoCientSide" href="VideoPlay.php?ID=' . $FetchVideoResults["videoId"] . '&VCat=3&VFol=0&VSFol=0">
